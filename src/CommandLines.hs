...
manCommand = putStrLn $ "Welcome to the manual !\n\n"
                     ...
                     ++ "While Loop:\n"
                     ++ "while (condition) {\n"
                     ++ "\t// Instructions to repeat as long as the condition is true\n}\n\n"
                     ...
                     ++ "    - greater(a, b): Checks if a is strictly greater than b.\n"
                     ++ "    - lower(a, b): Checks if a is strictly lower than b.\n"
                     ++ "    - leq(a, b): Check if a is less than or equal to b.\n"
                     ++ "    - geq(a, b): Check if a is greater than or equal to b.\n"
